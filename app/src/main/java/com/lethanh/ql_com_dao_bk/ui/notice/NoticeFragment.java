...
public class NoticeFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addButton(getString(R.string.view_notice), v -> Navigation.findNavController(v).navigate(R.id.nav_notice_list));
        addButton(getString(R.string.add_notice), v -> Navigation.findNavController(v).navigate(R.id.nav_notice_add));
    }
